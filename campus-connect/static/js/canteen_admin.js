/* Exact verified CSE admin behavior baseline used for Canteen admin. */
...
document.addEventListener("DOMContentLoaded", () => {
  const data = {
    ...
    applications: [
      {name:"Sai Teja", email:"saiteja@rgukt.ac.in", branch:"CSE", year:"3rd Year", phone:"+91 98765 20001", event:"Canteen Committee Registration", registrationId:"REG-2026-1042", skills:"Student coordination, event support", motivation:"I want to contribute to hostel activities and student welfare.", submitted:"Today, 9:10 AM", status:"Pending"},
      {name:"Meghana", email:"meghana@rgukt.ac.in", branch:"ECE", year:"2nd Year", phone:"+91 98765 20002", event:"Canteen Cultural Night Registration", registrationId:"REG-2026-1043", skills:"Event management, communication", motivation:"I would like to participate in organizing the hostel cultural night.", submitted:"Today, 8:55 AM", status:"Pending"},
      {name:"Harsha", email:"harsha@rgukt.ac.in", branch:"CSE", year:"1st Year", phone:"+91 98765 20003", event:"Canteen Committee Registration", registrationId:"REG-2026-1044", skills:"Coordination, volunteering", motivation:"Interested in helping with hostel-related student activities.", submitted:"Yesterday, 7:40 PM", status:"Pending"},
      {name:"Divya", email:"divya@rgukt.ac.in", branch:"EEE", year:"2nd Year", phone:"+91 98765 20004", event:"Canteen Maintenance Volunteer Registration", registrationId:"REG-2026-1045", skills:"Communication, organization", motivation:"I want to help improve communication between students and the hostel office.", submitted:"Yesterday, 4:30 PM", status:"Pending"}
    ],
    members: [
