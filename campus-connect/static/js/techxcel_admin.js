...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function createUpdateDetailCard() {
        ...
        // The TechXcel HTML already contains the modal markup.
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function identityEditor() {
    openModal("CLUB IDENTITY", "Edit TechXcel Club");
  ...
  function bindUpdate(el) {
    ...
    // Newly created updates are added after techxcel.js attaches click
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const meta = {
    ...
    members:{title:"New Club Member Registrations", desc:"Review students who submitted the TechXcel join form.", eyebrow:"MEMBER MANAGEMENT"}
  };
