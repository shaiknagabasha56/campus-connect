...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function bindUpdate(el) {
    ...
    // Newly created updates are added after aws.js attaches click
