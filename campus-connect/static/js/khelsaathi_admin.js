...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function createUpdateDetailCard() {
        ...
        // The Khelsaathi HTML already contains the modal markup.
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function identityEditor() {
    openModal("CLUB IDENTITY", "Edit Khelsaathi Club");
  ...
  function bindUpdate(el) {
    ...
    // Newly created updates are added after khelsaathi.js attaches click
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const meta = {
    ...
    members:{title:"New Club Member Registrations", desc:"Review students who submitted the Khelsaathi join form.", eyebrow:"MEMBER MANAGEMENT"}
  };
