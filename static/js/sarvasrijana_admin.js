...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function createUpdateDetailCard() {
        ...
        // The Sarvasrijana HTML already contains the modal markup.
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function identityEditor() {
    openModal("CLUB IDENTITY", "Edit Sarvasrijana Club");
  ...
  function bindUpdate(el) {
    ...
    // Newly created updates are added after sarvasrijana.js attaches click
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const meta = {
    ...
    members:{title:"New Club Member Registrations", desc:"Review students who submitted the Sarvasrijana join form.", eyebrow:"MEMBER MANAGEMENT"}
  };
