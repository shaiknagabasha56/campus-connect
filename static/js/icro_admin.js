...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function createUpdateDetailCard() {
        ...
        // The ICRO HTML already contains the modal markup.
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function identityEditor() {
    openModal("CLUB IDENTITY", "Edit ICRO Club");
  ...
  function bindUpdate(el) {
    ...
    // Newly created updates are added after icro.js attaches click
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const meta = {
    ...
    members:{title:"New Club Member Registrations", desc:"Review students who submitted the ICRO join form.", eyebrow:"MEMBER MANAGEMENT"}
  };
