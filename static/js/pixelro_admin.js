...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function createUpdateDetailCard() {
        ...
        // The Pixelro HTML already contains the modal markup.
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function identityEditor() {
    openModal("CLUB IDENTITY", "Edit Pixelro Club");
  ...
  function bindUpdate(el) {
    ...
    // Newly created updates are added after pixelro.js attaches click
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const meta = {
    ...
    members:{title:"New Club Member Registrations", desc:"Review students who submitted the Pixelro join form.", eyebrow:"MEMBER MANAGEMENT"}
  };
